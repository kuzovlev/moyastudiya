...
<header class="mt-3">
    <div class="featurebox col-md-12 col-sm-12 col-xs-12">
        <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <nav class="navbar navbar-expand-md col-sm-4 col-xs-6 justify-content-end navigation">
                <button class="navbar-toggler" type="button" data-toggle="collapse"
                        data-target="#collapsibleNavbar">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-menu-button" fill="currentColor"
