...
$(window).on("load", function () {
  ...
  if ($(".about-us-underline").length) {
    ...
    $(window).scroll(function () {
      let scrollAbout =
        $(window).scrollTop() > aboutUnder.position().top - $(window).height();
...
$(document).ready(function () {
  ...
  if ($("#services").length) {
    ...
    $(window).scroll(function () {
      let scrollService =
        $(window).scrollTop() >
        servicesHeader.position().top - $(window).height();
  ...
  if ($("#process").length) {
    ...
    $(window).scroll(function () {
      let scrollProcess =
        $(window).scrollTop() >
        processHeader.position().top - $(window).height();
  ...
  $(window).scroll(function () {
    let scrollForm =
      $(window).scrollTop() > cForm.position().top - $(window).height();
...
$(function () {
  ...
  $(".youtube").each(function () {
    ...
    $(document).delegate("#" + this.id, "click", function () {
      ...
      let iframe_url =
        "https://www.youtube.com/embed/" + videoID + "?autoplay=1&autohide=1";
...
$(document).ready(function () {
  ...
  $(".video-background, .modal-video, .video-background.modal-video").click(
    function () {
      let fullVideo = $(".full-video")[0];
      fullVideo.pause();
...
$(document).ready(function () {
  ...
  if (scrollProjects.length) {
    $(window).scroll(function () {
      let scrollEvent =
        $(window).scrollTop() >
        scrollProjects.position().top - $(window).height();
  ...
  if (
    $(".mainpage-svg-lg").length &&
    $(".mainpage-svg-lg").css("display") !== "none"
  ) {
    let jqBar = $(".mainpage-svg-lg"); // селектор для вашего блока
    let jqBarStatus = true;
    $(window).scroll(function () {
      let scrollEvent =
        $(window).scrollTop() > jqBar.position().top - $(window).height();
  ...
  if (
    $(".mainpage-svg-xxl").length &&
    $(".mainpage-svg-xxl").css("display") !== "none"
  ) {
    let mpxxl = $(".mainpage-svg-xxl");
    let mpxxlStatus = true;
    $(window).scroll(function () {
      let scrollEvent =
        $(window).scrollTop() > mpxxl.position().top - $(window).height();
  ...
  if (
    $(".mainpage-svg-xl").length &&
    $(".mainpage-svg-xl").css("display") !== "none"
  ) {
    let mpxl = $(".mainpage-svg-xl");
    let mpxlStatus = true;
    $(window).scroll(function () {
      let scrollEvent =
        $(window).scrollTop() > mpxl.position().top - $(window).height();
  ...
  if (
    $(".mainpage-svg-sm").length &&
    $(".mainpage-svg-sm").css("display") !== "none"
  ) {
    let mpsm = $(".mainpage-svg-sm");
    let mpsmStatus = true;
    $(window).scroll(function () {
      let scrollEvent =
        $(window).scrollTop() > mpsm.position().top - $(window).height();
  ...
  $(window).scroll(function () {
    let scrollFooter =
      $(window).scrollTop() > footer.position().top - $(window).height();
  ...
  wpcf7Elm.addEventListener(
    ...
    function (event) {
      ...
      if (window.location.href.indexOf("ru") > -1) {
        var formMess =
            "<div class='respon_mess'><p>В скором времени мы свяжемся с вами для уточнения деталей проекта</p></div>",
          formHeader = "Вашу заявку отримано!";
      }
      if (window.location.href.indexOf("en") > -1) {
        var formMess =
            "<div class='respon_mess'><p>We will contact you shortly to clarify the details of the project.</p></div>",
      ...
      if (
        ...
        var formMess =
            "<div class='respon_mess'><p>Незабаром ми з Вами зв'яжемось для уточнення деталей проєкту</p></div>",
  ...
  $.each(buttonsToHover, function (i) {
    ...
    $(window).scroll(function () {
      let btnEvent =
        $(window).scrollTop() > btnHov.position().top - $(window).height();
  ...
  function scrolling(e) {
    for (let i = 0; i < listItems.length; i++) {
      ...
      if (isPartiallyVisible(listItem)) {
        listItem.style =
          "animation-duration:1s; animation-name: fade-down; visibility: visible; transition-timing-function: ease-out";
      }
    }
    ...
    if (aboutUsRightBlock && isPartiallyVisible(aboutUsRightBlock)) {
      aboutUsRightBlock.style =
        "animation-duration:1s; animation-name: fade-portrait; visibility: visible; transition-timing-function: ease-out";
    }
    if (activitiesHeader && isPartiallyVisible(activitiesHeader)) {
      activitiesHeader.style =
        "animation-duration:1s; animation-name: fade-down; visibility: visible; transition-timing-function: ease-out";
    }
  }
...
$("#submit").click(function () {
  ...
  if (otpravka) {
    ...
    $.post(
      _templateDir + "/callback-mail.php",
      data,
      function (res) {
        var result =
          '<div style="color:#C99B69; text-align: center">' +
          res.text +
          "</div>";
