...
function moyastudiya_scripts() {
	...
	wp_enqueue_script( 'moyastudiya-custom', get_template_directory_uri() . '/js/custom.js?20', array(), false, true );
...
//	wp_enqueue_style( 'moyastudiya-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_enqueue_style( 'moyastudiya-style-main', get_template_directory_uri() . '/css/style.css?25', array(), false );
