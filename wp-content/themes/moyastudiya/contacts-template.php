        ...
        <div class="row justify-content-around">
            <div class="col-auto c-container">
                <div class="country-contacts country-ukraine">
                    ...
                    <a href="https://goo.gl/maps/7ZhC8GmcEh4M3aVYA" class="address" style="display:block; margin-bottom:0;" target="_blank"><?= get_field( 'address_ukr', 32 ); ?></a>
                    <?if (!empty(get_field( 'address_ukr_additional', 32 ))):?>
                        <a href="https://goo.gl/maps/7ZhC8GmcEh4M3aVYA" class="address" style="display:block;" target="_blank"><?= get_field( 'address_ukr_additional', 32 ); ?></a>
                    <?endif;?>
